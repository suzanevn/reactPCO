 ...
 /*   findAllChildren (id, results, depth) {
    ...
    forJson(){
        ...
        for(let i=0;i<this.state.dadosreais.length;i++){
            ...
            if(grupo!==this.state.dadosreais[i].GRUPO && contacontabil!==this.state.dadosreais[i].AK2_CO && centrocusto!==this.state.dadosreais[i].AK2_CC){
                grupo = this.state.dadosreais[i].GRUPO
                contacontabil = this.state.dadosreais[i].AK2_CO
                centrocusto = this.state.dadosreais[i].AK2_CC
                resultsConta=[]
            ...
            for(let j = 0; j<resultsTotal[i].length;j++){
                ...
                //esta vazio e nao achou o grupo, entao add
                    ...
                    arrayFinal.push({
                        ...
                        children: [{
                            key: resultsTotal[i][j].GRUPO+'+'+resultsTotal[i][j].AK2_CC,
                            children:[{
                                key: resultsTotal[i][j].GRUPO+'+'+resultsTotal[i][j].AK2_CC+'+'+resultsTotal[i][j].AK2_CO,
                                children:[{
                                    key: resultsTotal[i][j].GRUPO+'+'+resultsTotal[i][j].AK2_CC+'+'+resultsTotal[i][j].AK2_CO+'+'+'1',
                                data: {
